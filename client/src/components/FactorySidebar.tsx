...
import { RefreshCw, Download, ExternalLink, Copy, Plus } from 'lucide-react';
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center space-x-3">
                <Plus className="h-4 w-4 text-green-400 group-hover:text-green-400/80" />
                <span className="text-white">Create Token</span>
              </div>
